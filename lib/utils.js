 ...
 */
exports.getSigKey = function getSigKey (msg, sig) {
  const parsed = proto.schema.ECSignature.decode(sig)
...
exports.pubKeysAreEqual = function (a, b) {
...
exports.sigFromString = function (sig) {
  return new Buffer(sig, 'base64')
}
