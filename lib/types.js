...
// types.key = typeforce.anyOf(typeforce.String, typeforce.Object)

types.keyObj = function keyObj (val) {
  return val && (Buffer.isBuffer(val.pub) || Buffer.isBuffer(val.priv))
}

types.merkleRootOrObj = typeforce.anyOf(typeforce.Object, typeforce.Buffer)
...
types.linkOrObject = typeforce.anyOf(typeforce.String, types.signedObject)
